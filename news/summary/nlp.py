...
if __name__ == "__main__":
    url = 'http://dantri.com.vn/su-kien/duoi-suc-ep-cua-bao-chi-nguyen-bo-truong-ha-hung-cuong-tra-nha-cong-vu-20170619073437266.htm'
    ...
    rm_stopwords = [x for x in words if x.encode('utf-8') not in list(stopwords)]
    for rm_stopword in rm_stopwords:
        print rm_stopword
    print "-------STOP WORDS---------"
    # temp = "chơi"
    print type(words[0].encode('utf-8'))
